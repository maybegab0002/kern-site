...
const Omniportal = () => {
  ...
  const projectDetails = {
    ...
    year: '2025',
    technologies: ['React', 'Vite', 'TypeScript', 'Tailwind CSS', 'Git', 'Vercel', 'Supabase'],
    overview:
    ...
    challenges: [
      {
        ...
        description:
          'Designed and implemented a complex role-based system with three distinct user interfaces (Admin, Client, Agent) while maintaining code reusability and a consistent user experience across all portals.'
      },
      {
        title: 'Real-time Data Synchronization',
        description:
          'Leveraged Supabase real-time capabilities to ensure instant updates across all user dashboards when sales, payments, or inventory changes occur, preventing data inconsistencies.'
      },
      {
        title: 'Complex Commission Calculations',
        description:
          'Built a sophisticated commission tracking system that automatically calculates agent earnings based on sales data, deductions, and allowances while maintaining accuracy and transparency.'
      }
    ],
    process: [
      {
        phase: 'Planning & Architecture', duration: 'Week 1–2',
        activities: ['Gathered requirements from real estate stakeholders', 'Defined three distinct user roles and their access levels', 'Created database schema for properties, sales, payments, and commissions', 'Designed system architecture with Supabase backend', 'Established Git workflow and deployment pipeline']
      },
      {
        phase: 'UI/UX Design & Setup', duration: 'Week 2–3',
        activities: ['Set up React + Vite + TypeScript development environment', 'Configured Tailwind CSS with custom design system', 'Designed responsive layouts for all three portals', 'Created reusable component library', 'Built authentication flow with Supabase Auth']
      },
      {
        phase: 'Admin Dashboard Development', duration: 'Week 3–6',
        activities: ['Built comprehensive dashboard with analytics and KPIs', 'Implemented inventory management system', 'Developed payment processing and tracking module', 'Created ticketing system for client support', 'Built reporting module with data export capabilities', 'Integrated agent sales recording system']
      },
      {
        phase: 'Client Portal Development', duration: 'Week 6–8',
        activities: ['Developed secure payment gateway integration', 'Built balance statement viewing functionality', 'Created Statement of Account (SOA) generation', 'Implemented ticket submission system', 'Added document upload and management features']
      },
      {
        phase: 'Agent Portal Development', duration: 'Week 8–10',
        activities: ['Built commission tracking dashboard', 'Implemented sales upload functionality', 'Developed allowance tracking system', 'Created interactive leaderboard with rankings', 'Added performance analytics and insights']
      },
      {
        phase: 'Testing & Deployment', duration: 'Week 10–12',
        activities: ['Conducted comprehensive testing across all portals', 'Performed security audits and penetration testing', 'Optimized performance and load times', 'Set up CI/CD pipeline with Vercel', 'Deployed to production and monitored stability', 'Created user documentation and training materials']
      }
    ],
    features: [
    ...
    results: [
      { value: '50+', label: 'Real estate agents served', sub: 'Successfully launched' },
      { value: '200+', label: 'Transactions / month', sub: 'Processing volume' },
      { value: '60%', label: 'Admin overhead reduced', sub: 'Operational efficiency' },
      { value: '99.9%', label: 'Commission accuracy', sub: 'Financial precision' },
  ...
  const scopeCards = [
    {
      num: '01', title: 'Admin Dashboard',
      items: ['Inventories Management', 'Balance Tracking', 'Payment Processing', 'Ticketing System', 'Dashboard Analytics', 'Comprehensive Reports', 'Agent Sales Recording']
    },
    {
      num: '02', title: 'Client Portal',
      items: ['Secure Payment Gateway', 'Balance Statement Viewing', 'Statement of Account (SOA)', 'Ticket Submission', 'Document Management']
    },
    {
      num: '03', title: 'Agent Portal',
      items: ['Commission Tracking', 'Sales Upload System', 'Allowance Tracking', 'Performance Leaderboard', 'Analytics & Insights']
    }
  ];
    ...
    <div style={{ fontFamily: bodyFont, backgroundColor: '#fff', color: '#0E0E0E', minHeight: '100vh' }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 2rem', position: 'relative', zIndex: 1 }}>
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.65 }}>
            ...
            <p style={{
              fontSize: '1.1rem', lineHeight: 1.72, color: '#6B6B6B',
              maxWidth: 520, fontWeight: 300, marginBottom: '3.5rem'
            }}>
            ...
            <div style={{
              ...
              {[
                ...
                <div key={i} style={{
                  ...
                  borderRight: i < 2 ? '1px solid #E4E4E0' : 'none'
                }}>
      ...
      <section style={{ backgroundColor: '#F7F7F5', padding: '4rem 3.5rem', borderBottom: '1px solid #E4E4E0' }}>
        ...
        >
          <div style={{
            ...
            <img src={omniportalMockup} alt="Omniportal Interface" style={{ width: '100%', height: 'auto', display: 'block' }} />
          </div>
        </motion.div>
      </section>
          ...
          >
            <div>
              ...
              <h2 style={{ fontFamily: displayFont, fontSize: 'clamp(1.75rem, 3.5vw, 2.5rem)', fontWeight: 700, letterSpacing: '-0.025em', lineHeight: 1.15, color: '#0E0E0E' }}>
                Three portals.<br />One unified system.
              </h2>
            </div>
            <p style={{ fontSize: '0.96rem', color: '#6B6B6B', lineHeight: 1.75, maxWidth: 400, fontWeight: 300 }}>
              Each user role gets a dedicated interface tailored to their workflow — sharing a single, consistent Supabase backend.
            </p>
          </motion.div>
      ...
      <section style={{ padding: '6rem 3.5rem', backgroundColor: '#F7F7F5', borderBottom: '1px solid #E4E4E0' }}>
        <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 2rem' }}>
          ...
          >
            ...
            <p style={{ fontSize: '0.96rem', color: '#6B6B6B', lineHeight: 1.75, maxWidth: 400, fontWeight: 300 }}>
              A structured 12-week build from requirements to production deployment, with weekly check-ins throughout.
            </p>
          </motion.div>
      ...
      <section style={{ padding: '6rem 3.5rem', backgroundColor: '#F7F7F5', borderBottom: '1px solid #E4E4E0' }}>
        <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 2rem' }}>
          ...
          {/* Row 1: 4 stats */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 1, background: '#E4E4E0', border: '1px solid #E4E4E0', borderRadius: '14px 14px 0 0', overflow: 'hidden' }}>
            {projectDetails.results.slice(0, 4).map(({ value, label, sub }, i) => (
              <motion.div
                key={i}
          ...
          {/* Row 2: 3 stats */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 1, background: '#E4E4E0', border: '1px solid #E4E4E0', borderTop: 'none', borderRadius: '0 0 14px 14px', overflow: 'hidden' }}>
            {projectDetails.results.slice(4).map(({ value, label, sub }, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: (i + 4) * 0.08 }}
                style={{ background: '#fff', padding: '2rem 2rem', transition: 'background 0.18s', cursor: 'default' }}
                onMouseEnter={(e) => { (e.currentTarget as HTMLDivElement).style.background = '#F7F7F5'; }}
                onMouseLeave={(e) => { (e.currentTarget as HTMLDivElement).style.background = '#fff'; }}
              >
